...
from FiftyBot_state_setter import FiftyBotStateSetter
from rlgym.utils.terminal_conditions.common_conditions import NoTouchTimeoutCondition, GoalScoredCondition
from FiftyBot_terminal_condition import FiftyBotTerminalCondition
from rlgym_tools.sb3_utils import SB3MultipleInstanceEnv
from rlgym.utils.reward_functions.common_rewards.misc_rewards import EventReward
from rlgym.utils.reward_functions.common_rewards.player_ball_rewards import VelocityPlayerToBallReward
from FiftyBot_reward import FiftyBotReward
...
if __name__ == '__main__':  # Required for multiprocessing
    ...
    batch_size = steps//5   # getting the batch size down to something more manageable - 100k in this case
    ...
    def get_match():  # Need to use a function so that each instance can call it and produce their own objects
        return Match(
            ...
            (0.05, 1.0, 1.0)),
            self_play=True,
            terminal_conditions=[NoTouchTimeoutCondition(fps * 45), GoalScoredCondition(), FiftyBotTerminalCondition()],
            obs_builder=AdvancedObs(),  # Not that advanced, good default
            state_setter=FiftyBotStateSetter(),  # Resets to kickoff position
